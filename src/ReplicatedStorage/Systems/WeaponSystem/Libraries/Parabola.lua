...
function Parabola:_findPart(funcName, list)
	...
	local hitPart, hitPoint, hitNormal, hitMaterial, hitT =
		nil, self.referenceFrame.p, DEFAULT_NORMAL, Enum.Material.Air, 0
...
function Parabola:findSpheresHit(sphereTable, radius) end
